	...
	<div class="col-md-12">
		<div class="portlet box blue">
			<div class="portlet-title">
				<div class="caption">
					<i class="fa fa-globe"></i>View Settings
				</div>
			</div>
					...
					<ul class="nav nav-tabs">
						<s:if test='%{#session.previousYear == "N"}'>
							<li>
								...
								<sj:a href="%{addAccountMaster}" targets="accountMasterContentDiv" indicator="indicator" data-toggle="tab">General Settings</sj:a>
							</li>
							<li>
								<s:url id="doAddCategories" action="ajaxDoAddCategories" namespace="/account"/>
								<sj:a href="%{doAddCategories}" targets="accountMasterContentDiv" indicator="indicator" data-toggle="tab">Account Settings</sj:a>
							</li>
						</s:if>
						<li class="active">
							<s:url id="viewMaster" action="ajaxViewCreateAccountMaster"	 namespace="/account"> </s:url>

	...
	<div id="commonTabWrapper">
		<div id="commonStep">
			<fieldset style="padding:15px 19px 5px 1px">
				<s:form action="ajaxSaveDeleteInvoice" id="deleteInvoiceNumber" method="post"
					theme="css_xhtml">
					...
					<div class="grid_13">
						<div class="grid_9">
							...
							<div class="grid_4 alpha">
								<input type="password" name="customer.deleteInvoicePassword" id="deleteInvoicePassword" maxlength="40" class="textfield">
							</div>

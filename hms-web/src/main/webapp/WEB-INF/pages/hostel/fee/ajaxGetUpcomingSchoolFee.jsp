<%@ include file="/common/taglibs.jsp"%>
		            <s:if test="%{studentFeeUpcomeingList != null && !studentFeeUpcomeingList.isEmpty() && classList !=null && !classList.isEmpty()}">
		            <div class="grid_11">
				    <h6><a href="#"> UpComing Payments for 15 days(<del><b style="font-size:14px;">&#2352;</b></del>---<s:property value="totalAmount"/>)<!--(<s:property value="studentFeeUpcomeingList.size"/>)--></a></h6>
					 <br/>
					...
					<div id="resultsPage">
					   <%int i = 0; %>
					    <s:iterator value="studentFeeUpcomeingList">
		              ...
		              <s:else>
		              There are no students fee  for next 15 days.
		              </s:else>
	<style type="text/css">
	.active
	{

	...
	<div id="commonTabWrapper">
		<div id="commonStep">
			<fieldset style="padding:15px 19px 5px 1px">
				<s:form action="ajaxSaveModifyHostelStudentInvoice" id="modifyStudentInvoiceNumber" method="post"
					theme="css_xhtml">
					...
					<div class="grid_9">
						...
						<sj:submit   targets="searchStudentsForm112" value="Submit" indicator="indicator"
							cssClass="submit small right" formIds="modifyStudentInvoiceNumber" validate="true"  onClickTopics="checkStudentModifyPassword"/>
					</div>
...
<script type="text/javascript">
$.subscribe('checkStudentModifyPassword', function(event, data) {

					...
					<div class="grid_15">&nbsp;</div>
						<div class="grid_13">
							<s:url id="doCancelStudent"
								action="ajaxSearchStudentFeeByCriteria" namespace="/hostel"
								includeParams="all" escapeAmp="false">
								<s:param name="id" value="%{id}" />
							</s:url>
							<sj:a href="%{doCancelStudent}" cssClass="cancelButton"
								indicator="indicator" targets="searchStudentsList">Cancel</sj:a>
							<sj:submit   cssClass="submit green long" value="Pay & Print" id="payPrintFormSubmitBtnId"
							...
							<sj:submit   cssClass="submit small" value="Pay" id="payFormSubmitBtnId"
								indicator="indicator" targets="searchStudentsForm112"
			...
			<div id="steps">
				<s:iterator value="classFeeList">
					...
					<s:if test="%{hostelTermId != #hostelTermsId}">
						...
						<div class="grid_14">
							<b style="color: #806517;">Due Date: <s:property value="dueDateStr" /> </b>
								...
								<s:if test="%{hostelFeeTypeList!= null || hostelFeeTypeList!= null}">
									<s:iterator value="hostelFeeTypeList">
									 <s:if test='%{invoiceNumber > 0}'>
										<a id="noPrint"
                                            onClick="javascript:printHostelPreview('<s:property value='studentId'/>',
					...
					<div class="grid_7">
						...
						<div class="grid_2">
							...
							<s:if test='%{feeType == "Hostel Fee"}'>

								<c:set value="${feeAmount + student.bed.bedCost}" var="priceAmt" />
					...
					<div class="grid_2">
						<div
							id="divInnerHtmli<s:property value='studentPaymentId'/>"
...
<s:else>
 	Hostel category or fees are not configured for this student.
 </s:else>
 </div>
				 ...
				 for(var i=0; i< termIds.length;i++ )
	        	   {
					...
					$('#payPrintFormSubmitBtnId').removeAttr('disabled');
					return false;	
			}

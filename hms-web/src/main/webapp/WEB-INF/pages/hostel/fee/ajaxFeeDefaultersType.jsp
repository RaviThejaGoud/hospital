...
<div class="grid_8">
	<div class="grid_4" style="margin-right: 40px;">
		<form name="myform2" action="${pageContext.request.contextPath}/reports/ajaxPrintHostelStudentDefaulters.do?pdfId=pdf" target="_new">
...
var pars = "yourOptionValue=" + yourOptionValue;
	if (yourOptionValue== "CD")
	  {
	  	var url = jQuery.url.getChatURL("/hostel/ajaxDoClassWiseDefaulters.do");
		  	$.ajax( {
			url : url,
			cache : false,
			data : pars,

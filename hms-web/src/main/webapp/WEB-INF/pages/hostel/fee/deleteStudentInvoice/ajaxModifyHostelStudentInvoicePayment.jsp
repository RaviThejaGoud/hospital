			...
			<fieldset>
				<div class="grid_15">
					...
					<div class="grid_15">
						...
						<input type="radio" value="C" name="paymentType" id="cashForm"
								onclick="javascript:paymentTypeMethodChange(this.value)">
							Cash&nbsp;&nbsp;
							<input type="radio" value="D" name="paymentType" id="ddForm"
								onclick="javascript:paymentTypeMethodChange(this.value)">
							DD&nbsp;&nbsp;
							<input type="radio" value="CH" name="paymentType" id="chForm"
...
$(document).ready(function() {
	...
	$.subscribe('studentPaymentFormValidation', function(event, data) {
		if ($('#addStudentPaymentFee').valid()) {
			...
			var isBankSelected = $('#bankForm').attr('checked');

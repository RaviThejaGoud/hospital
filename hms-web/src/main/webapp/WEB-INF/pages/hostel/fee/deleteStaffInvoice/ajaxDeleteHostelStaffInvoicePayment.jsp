...
<div id="searchStudentsForm112" class="commonFormTabs">
	<div id="tabWrapper">
		<s:form action="ajaxDeleteHostelStaffInvoicePayment" id="deletePaymentFee" method="post" theme="css_xhtml" name="myform" namespace="/hostel">
			<input type="hidden" name="staffNumber" value='<s:property value="staff.id" />'/>
			<s:hidden id="termIdsIds" name="invoiceNumber"  value="%{hostelStaffPayment.invoiceNumber}" />
			...
			<fieldset>
				<div class="grid_15">
					...
					<div class="grid_15">
								...
								<div class="grid_8">
									<s:property value="hostelStaffPayment.paidAmount" />
								</div>
							</div>
							<div class="grid_15">
								<div class="grid_7">
								...
								<div class="grid_8">
									<s:property value="hostelStaffPayment.discountAmount" />
								</div>
							</div>
							<div class="grid_15">
								<div class="grid_7">
								...
								<div class="grid_8">
									<s:property value="hostelStaffPayment.invoiceNumber" />
								</div>
							</div>
							<div class="grid_15">
								<div class="grid_7">
								...
								<div class="grid_8">
									<s:if test='%{hostelStaffPayment.paymentType == "D"}'>
										DD
									</s:if>
									<s:elseif test='%{hostelStaffPayment.paymentType == "CH"}'>
										Cheque
									</s:elseif>
									<s:else>
										Cash
							...
							<div class="grid_15">
								<s:if test='%{hostelStaffPayment.paymentType == "D"}'>
									...
									<div class="grid_8">
										<s:property value="hostelStaffPayment.ddNumber" />
									</div>
									<div class="grid_15 &nbsp;"></div>
									<div class="grid_7">
										<label class='labelRight'>
									...
									<div class="grid_8">
										<s:property value="hostelStaffPayment.bankMaster.bankName" />
									</div>
									<div class="grid_15 &nbsp;"></div>
									<div class="grid_7">
										<label class='labelRight'>
									...
									<div class="grid_8">
										<s:property value="hostelStaffPayment.branchName" />
									</div>
								</s:if>
								<s:elseif test='%{hostelStaffPayment.paymentType == "CH"}'>
									<div class="grid_7">
									...
									<div class="grid_8">
										<s:property value="hostelStaffPayment.chequeNumber" />
									</div>
									<div class="grid_15 &nbsp;"></div>
									<div class="grid_7">
										<label class='labelRight'>
					...
					<div class="grid_13">
						<s:url id="doCancelInvoice" action="ajaxViewHostelStudentInvoiceModifyers"
							namespace="/hostel" includeParams="all" escapeAmp="false">
							<s:param name="id" value="%{id}" />
						</s:url>
						<sj:a href="%{doCancelInvoice}" cssClass="cancelButton"
			...
			<div id="steps">
				<s:iterator value="classFeeList">
					<input type="hidden" id="divInnerHtml<s:property value="staffPaymentId"/>" value="<s:property value="paymentTypeStr" />"></input>
								...
								<s:if test="%{schoolFeeList!= null || schoolFeeList!= null}">
									<s:iterator value="schoolFeeList">
									 <s:if test='%{invoiceNumber > 0}'>
										<a id="noPrint"
                                            onClick="javascript:printPreview('<s:property value='staffId'/>',
					...
					<s:else>
						...
						<script type="text/javascript">
								highLightFeeDueTab('<s:property value="hostelTermsId" />','<s:property value="fromMonthName" />','<s:property value="toMonthName" />');
							</script>
					</s:else>
					<div class="grid_7">
						<div class="grid_5">
...
<s:else>
 	Fees not configured for this staff class.
 </s:else>
 </div>

		...
		<div class="portlet box blue">
			...
			<div class="portlet-body" id="storeDetails">
				<div class="tab-content">
					...
					<div class="form-body">
						<s:if	test="%{(suppliersList != null && !suppliersList.isEmpty())}">
							<div class="form-group">
								<div class="col-md-12">
									<div class="checkbox-list">
										<label class="checkbox-inline">
											<input type="checkbox" name="" value="" onClick="checkAllStores()"	class="checkbox allClasses">All Suppliers
										</label>
									</div>
								</div>
							</div>
							<div class="form-group">
								<div class="col-md-12">
									<div class="checkbox-list">
										<s:checkboxlist name="chkBoxSelectedIds"	list="suppliersList" listKey="id" listValue="supplierName" theme="ems" cssClass="small" />
									</div>
								</div>
							</div>
					...
					<s:else>
								Currently No Suppliers are available.
					</s:else>

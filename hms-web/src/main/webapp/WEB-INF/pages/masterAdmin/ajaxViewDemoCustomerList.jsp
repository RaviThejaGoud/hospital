	...
	<s:form id="selectStudentForm" cssClass="form-horizontal"
		...
		<s:if test="%{customersList != null && !customersList.isEmpty()}">
			<h4 class="bold text-success">
				...
				<s:property value="customersList.size" /> ( Active : <s:property value="tempId2" /> , Inactive: <s:property value="tempId1" /> ) 
			</h4>
		...
		<s:else>
			<div class="alert alert-info">Currently there are no Customer
				details.</div>
		</s:else>
	</s:form>
</div>

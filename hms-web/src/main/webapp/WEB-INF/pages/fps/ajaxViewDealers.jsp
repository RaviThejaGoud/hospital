	...
	<div class="col-md-12">
		<div class="portlet box blue">
			<div class="portlet-title">
				<div class="caption">
					<i class="fa fa-globe"></i>Dealer Details
				</div>
			</div>
									...
									<div class="form-group">
										...
										<div class="col-md-8">
											<s:select id="districtId" list="tempList"
												cssClass="required form-control input-medium" listKey="districtName"
...
function getDealersListByDistrict(districtId) {
  	if (districtId == "") {
		...
		var url = jQuery.url.getChatURL("/fps/ajaxDealerDetaislByDistrictId.do");
		$.ajax( {
			url : url,
			cache : false,
			data : pars,

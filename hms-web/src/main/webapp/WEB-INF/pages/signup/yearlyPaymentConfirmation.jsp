		...
		<div class="wrapper block">
			<div class="block_head">
				...
				<div id="signupStep1" class="block_content"
					    ...
					    <s:iterator value="urtProductList">
							<div class="grid_9" align="left">
								<h3 style="font-size: 17px">
									<s:property value="name"/>  Subscription - Yearly
								</h3>
							</div>
							<div class="grid_6">
								<h3 style="font-size: 17px;" >
					...
					<div class="grid_16">
						<div class="grid_9" align="left">
							<h3 style="font-size: 17px; color: #CCCCCC;">
								<i>Renews on the <s:property value="renewdate" /> of every
									year</i>
							</h3>
						</div>
					</div>
					...
					<div class="grid_16">
						...
						<div class="grid_4">
							<b style="font-size: 17px"> Total per Year </b>
						</div>
						<div class="grid_2">
							<h3 style="font-size: 17px" >
								$
					...
					<div class="grid_16">
						<div class="grid_4 omega" style="float: right;margin-right;">

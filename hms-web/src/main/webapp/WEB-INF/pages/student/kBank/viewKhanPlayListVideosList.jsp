	...
	<div style="padding-top: 1px">
		<ul id="resultsPage">
			<s:iterator value="playListVideoSet">
				<li>
					<a href="<c:url value='/student/ajaxPlaySelectedVideo.do' />?id=<s:property value="id"/>" class="playVideo video-link" title="<s:property value="title"/>" onclick="javascript:writeNewVideo('<s:property value="playListVideo.youtubeId"/>')" ><s:property
							value="title" />
					</a>
			<br clear="all"/>
				</li>

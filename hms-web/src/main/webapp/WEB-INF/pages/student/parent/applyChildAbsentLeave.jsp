...
<s:form action="ajaxApplyChildAbsentLeaveDetailsForParent" theme="css_xhtml" id="editLeaveReportForParent" namespace="/student">
	...
	<div class="grid_11">
		<div class="grid_6">
			...
			<s:url id="doCancelLeave" action="ajaxCancelChildAbsentLeaveDetailsForParent"

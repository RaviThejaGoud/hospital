...
<div class="grid_3 alpha omega" style="width: 180px;margin-top: 10px;">
	...
	<div class="block_content" id="sideMenu" style="padding: 10px;">
		<s:if test="%{studentsBirthdaysList != null && !studentsBirthdaysList.isEmpty()}">
			<marquee DIRECTION="up" scrollamount="2">
				<div style="padding-top: 1px">
					<s:iterator value="studentsBirthdaysList">
		...
		<s:else>
		Currently there are no up coming birthdays.
		</s:else>
		</div>
	 </div>
	</div>

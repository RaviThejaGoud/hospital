			...
			<div class="portlet-body">
				<div class="tabbable tabbable-custom tabbable-full-width">
					...
					<%-- <s:if test='%{user.isOnlySchoolAdmin == "Y" || user.roleName=="ROLE_VICEPRINCIPAL" || user.isSchoolPrincipal=="Y" || tempBoolean || user.isOnlySchoolHod=="Y" || user.isSchoolDirector == "Y"}'>
						...
						<li class="active">
							<s:url id="viewCalendarIndo" action="ajaxViewCalendarInformation" namespace="/staff"></s:url>
							<sj:a id="viewCalendarIndo" href="%{viewCalendarIndo}" targets="mainContentDiv" data-toggle="tab">View Calendar</sj:a>
						</li>
					</ul>
					<div id="taskInfoContentDiv" class="tab-content">
						<%@ include file="/common/messages.jsp"%>
						<jsp:include page="/WEB-INF/pages/staff/calendar/ajaxViewCalendarInformation.jsp"></jsp:include>
					</div>
				</div>
			</div>
		</div>

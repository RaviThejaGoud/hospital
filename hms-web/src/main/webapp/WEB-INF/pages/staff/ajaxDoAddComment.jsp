			...
			<div class="block_content">
				<s:if test="%{knowledgeBank != null}">
					...
					<div id="formattedMsg"></div>
						...
						<div>
						<s:form action="ajaxAddKBankComments" theme="css_xhtml" id="addPostKBankComments" method="post" namespace="/admin">
							...
							<div class="grid_9">
								...
								<div class="grid_6">
									<sj:textarea rows="3" cols="20" name="kBankComments.description" cssStyle="width:88%" 
										cssClass="text small  word_count required" required="true" requiredposition="left"></sj:textarea>
								</div>
							</div>
							<div class="clear"></div>

...
<div id="uploadLibraryBooks">
	...
	<s:form id="importSchoolBooks" action="ajaxUploadLibraryBooksTemplate" enctype="multipart/form-data"
		...
		<s:hidden name="alertSendType" id="uploadType" value="new"></s:hidden>
		<h4 class="pageTitle bold">
			Download template to import books
		</h4>
		<div class="form-body">
			<div class="panel-body col-md-12">
				...
				<div class="col-md-10">
					<ul>
						<li>
							Please download the books import excel sheet by clicking the "Download Template" button below. 
						</li>
						<li>
			...
			<div class="form-group">
				<label class="col-md-2 control-label">Book Number :</label>
				<div class="col-md-8">
					<div class="radio-list">
						<label class="radio-inline">
						 <input type="radio" name="bookNumberGenerate" value="AG"
					checked="checked" /> System Generates </label>
						<label class="radio-inline">
						<input type="radio" name="bookNumberGenerate" value="MG" />Manual Generates </label>
					</div>
				</div>
			</div>
			<div class="form-actions fluid">
				...
				<div class="col-md-offset-0 col-md-1">
					<s:url id="doViewLibraryBooksBackLink" action="ajaxLibraryHome"
						includeParams="all" escapeAmp="false" namespace="/library">
					</s:url>
					<sj:a href="%{doViewLibraryBooksBackLink}" cssClass="btn default"

...
<s:form action="" id="searchText" method="post" theme="simple"
	...
	<div class="form-group">
		...
		<div class="col-md-2">
			<sj:textfield name="searchWord" id="searchString" 
	...
	<div class="form-group">
		...
		<s:select
			...
			id="selectedClassType" name="selectedClassType" 
			cssClass="form-control input-medium"></s:select>
		</div>
	</div>
	<div class="form-group">
	...
	<div class="col-md-4">
		<s:submit type="submit" cssClass="btn blue" value="Search"
			...
			onclick="javascript:studentSearchKeyWords(); return false;" />
	</div>
...
function studentSearchKeyWords() {
	...
	var url = jQuery.url.getChatURL("/library/ajaxStudentSearchKeyWords.do");
	if (searchWord.length == 0 || searchWord == 'Please enter book title') {
		...
		var pars = "searchWord=" + searchWord + "&searchBy=" + searchBy
				+ "&selectedType=" + selectedType + "&selectedDate="
				+ $('input#reservationDate').val();
		$.ajax( {
				url : url,
				cache : false,
				data : pars,

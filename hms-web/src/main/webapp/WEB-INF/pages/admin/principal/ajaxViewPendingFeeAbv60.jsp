...
<div class="block grid_17" id="pendingStudentsFeeList">
	...
	<div class="block_content" id="">
	<s:if
		test="%{studentFeeAbove60List != null && !studentFeeAbove60List.isEmpty() && schoolFeeList !=null && !schoolFeeList.isEmpty()}">
		<div class="grid_17">
			<h6>
				<a href="#"> Pending 60 and Above days(<del>
						<b style="font-size: 14px;">&#2352;</b>
					</del>---<s:property value="totalAmount" />)--(<s:property
						value="studentFeeAbove60List.size" />)</a>
			</h6>
			<br />
			<table class="striped" width="100%" cellpadding="1" style="margin-bottom: 0;" cellspacing="1" id="results">
				<thead>
					<tr>
			...
			<div id="resultsPage">
				<%int i = 0; %>
				<s:iterator value="studentFeeAbove60List">
					<s:set name="rollNum" value="rollNumber" />
					<table class="striped" width="100%" cellpadding="1"
						style="margin-bottom: 0;border-width: 1px 1px 1px;" cellspacing="1" id="results">
						<tr class="loaded">
							<!--<td  width="8%">
									<%i++; %><%=i %>
								</td>-->
	...
	<s:else>
		There are no students fee pending for more than 60 days.
    </s:else>	
</div>
</div>
<style type="text/css">

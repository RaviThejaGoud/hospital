...
<div class="block grid_17" id="pendingStudentsFeeList">
	<div id="pendingStudentsFeeList">
		<jsp:include
			page="/WEB-INF/pages/schoolfee/ajaxViewStudentPendingFeeList.jsp" />
	</div>
	<div class="block_content">
		<s:if
			test="%{studentFee14List != null && !studentFee14List.isEmpty() && objectList !=null && !objectList.isEmpty()}">
			<div class="grid_17">
				<h6>
					<a href="#"> Pending 0-14 days(<del>
							<b style="font-size: 14px;">&#2352;</b>
						</del>---<s:property value="totalAmount" />)--(<s:property
							value="studentFee14List.size" />)</a>
				</h6>

...
<div id="attendanceDiv" style="display: none;">
	<s:if test="%{absentList != null && !absentList.isEmpty()}">
			<div >
				<a href="printMyAttendance.do?accountId=<s:property value='tempId'/>" 
					target="_new"><img alt="Print" title="Print" src="../images/common/printer.png"> </a>
			</div>
			<table class="striped" width="100%" style="margin-bottom: 0;" cellpadding="1" cellspacing="1">
			<tr>
				<th>
				...
				<s:if test='%{anyId == currentYear && selectedId == currentYear}'>
					...
					<s:elseif test="%{anyId != currentYear}">
					<tr class="loaded">
					<td>
					<s:property value="currentYear" />
					</td>

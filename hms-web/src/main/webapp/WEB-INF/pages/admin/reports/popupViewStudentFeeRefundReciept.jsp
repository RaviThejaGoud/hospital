...
<%-- <s:if test='%{customer.feeReceiptModel=="General"}'> --%>
 <div style="width: 100%; padding: 10px;">
	<div style="width: 49%; float: left; border: 1px solid">
		<jsp:include page="/WEB-INF/pages/admin/reports/feeReciept/generalFeeRefundReciept.jsp"></jsp:include>
...
<div align="center">
	<page size='<s:property value="customer.feeReceiptModel"/>' id="pageToPrint" >
		...
		<div class="pageHeader1">
			...
			<div class="col-md-6 generatedBy">Generated By:<a id="myAnchor" href="http://www.Eazyschool.com" target="_blank">www.Eazyschool.com</a> </div>
		</div>
	...
	<page size='<s:property value="customer.feeReceiptModel"/>' id="pageToPrint">
		<div style="width: 100%; padding: 10px;">
			<div style="width: 48%; float: left; border: 1px solid;margin: 5px;height: 14cm;">
				...
				<div class="generatedBy"  style="font-size: 8px;margin-top: -5px;"> 
					Generated By:<a id="myAnchor" href="http://www.Eazyschool.com" target="_blank">www.Eazyschool.com</a> 
				</div>
			</div>

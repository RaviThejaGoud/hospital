				...
				<s:set name="schoolTermsId" value=""></s:set>
					...
					<tbody class="tabTotalTDClass" id="tabTotalTDClass">
						...
						<s:iterator value="studentPaymentList">
							...
							<s:if test="%{schoolTermId != #schoolTermsId}">
								...
								<tr>
									...
									<td
										style="text-align: center; border-bottom: 0px solid; border-top: 0px solid; border-left: none; border-right: 1px solid; width: 70%;">
						...
						<s:if test="%{thirtyTotalAmount > 0}">
							...
							<span id="discountAmount" class="<s:property value='thirtyTotalAmount'/>"> </span>
						</s:if>
						<s:else>
							<span id="discountAmount" class="<s:property value='thirtyTotalAmount'/>"> </span>
						</s:else>
...
for(var j=0;j<3;j++){
	...
	var discountAmt = document.getElementById("discountAmount").className;
	var showBalance = document.getElementById("showBalanceAmount").className;
	...
	//alert("discountAmt :"+discountAmt+" showBalance :"+showBalance+" maxLength"+maxLength)

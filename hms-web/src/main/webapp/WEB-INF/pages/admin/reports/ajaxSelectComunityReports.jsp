			...
			<div class="portlet-body">
					<div class="tab-content">
						<s:if
							...
							<s:form action="ajaxPrintStudentSchoolWideCommunityDetails"
								...
								<s:if
									test='%{tempString == "Student" && anyTitle == "ClassWiseCommunityDetails"}'>
									<div class="form-group">
										<label class="conLable col-md-3 control-label">
...
function generateClassCommunityIds() {
	if ((($("input[name=chkBoxSelectedIds]:checked").length > 0)
		...
		return false;
			...
			&& ($("input[name=communityCheckBoxes]:checked").length == 0) && ($("input[name=genderName]:checked").length == 0))) {
		alert("Please select at least one community and gender");
		return false;
	} else if ((($("input[name=chkBoxSelectedIds]:checked").length == 0)
			&& ($("input[name=communityCheckBoxes]:checked").length > 0) && ($("input[name=genderName]:checked").length == 0))) {
		...
		return false;
			...
			&& ($("input[name=communityCheckBoxes]:checked").length == 0) && ($("input[name=genderName]:checked").length == 0))) {
		alert("Please select at least one class ,community and gender");
		return false;
	} else {
		return false;
	}

	...
	<div class="block_head">
		...
		<ul>
			<s:if test='%{user.isOnlySchoolAdmin=="Y"}'>
				<li>
					<a id="adminStaffAndStudent"
						href="${pageContext.request.contextPath}/admin/adminManageStaffAndStudent.do"
						class="current">Back To Admin</a>
				</li>
			</s:if>
		</ul>
	</div>
	<div class="block_content">
		<div class="grid_11">
			<s:if test="%{(vehicleList != null && !vehicleList.isEmpty())}">
				<s:form action="ajaxVehicleDefaultersFeeCollectionWiseReport"
					theme="css_xhtml" namespace="/reports" target="_new"
					...
					<div class="grid_10 checkbox">
						...
						All Vehicles
						<s:checkboxlist name="chkBoxSelectedIds" list="vehicleList"
							theme="ems" listKey="id" listValue="vehicleTypeAndVehicleNumber"

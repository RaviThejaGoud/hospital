...
<s:if test="%{weekDayList != null && !weekDayList.isEmpty()}">
	<s:if test="%{timeTablePeriodList != null && !timeTablePeriodList.isEmpty()}">
		<p style="float: left"><span class="label label-important">NOTE!</span></p><span class="foo blue">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Theory</span>
		 	<span class="foo purple">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Lab</span><span class="foo wine"  style="float: left;margin: 25px; margin-top: 2px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Elective</span>
				...
				<thead>
					<tr>
						<th style="background-color: #efefe7">
							<p style="text-align: center;"><b>Day / Time </b></p>
						</th>
							...
							<s:iterator value="timeTablePeriodList" status="stat">
								...
								<s:else>
									<td style="border: 1px solid #efefe7" id="monthPeriodSubjectViewId<s:property value='%{#weekId}'/><s:property value='%{#periodId}'/>" rowspan="1" class="addRowSpanVal">
										<span id="subjectValue" cssStyle="width:45%" style="text-align: center; color:#FFFFFF"></span> 
...
<script type="text/javascript">
	$(document).ready(function() {
		$('.numeric').numeric();
		var studyClassId = '<s:property value="classSectionId" />';
							...
							$(this).find('td').each(function(){
								if($(this).hasClass('addRowSpanVal')){
									if(isNonEmpty($(this).find('span#subjectValue').text()) && isNonEmpty($(this).find('span#subjectValue').next().text())){
										...
										Current_td = $(this);
										if("E"==inputSubjectType){
											Current_td.css({'background-color' : '#1eb5e5','text-align' : 'center'});
										}else if(inputPeriodCount >0){
											if("L"==inputSubjectType)
									...
									}else if(isEmpty($(this).find('span#subjectValue').text())){
										$(this).find('span#subjectValue').text("--");

		...
		<tbody>
			...
			<s:else>
				<div class="alert alert-info">
					Currently Timetable is not generated for the selected staff. 
				</div>
			</s:else>
...
$(document).ready(function() {
	...
	var dataURL = jQuery.url.getChatURL("/timeTable/ajaxGetStaffWiseTimetableData.do?tempId=" + staffId);
	$.ajax( {
				url : dataURL,
				cache : false,
				dataType : 'json',

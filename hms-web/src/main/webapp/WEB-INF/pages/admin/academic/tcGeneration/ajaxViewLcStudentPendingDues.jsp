...
<jsp:include page="/common/messages.jsp" />
	<s:if test="%{tcSettings != null}">
		<s:form id="studentGenerateTcInfoForm" method="post" theme="simple"
			action="ajaxGenerateLc" cssClass="form-horizontal" namespace="/admin"
			...
			<span class="label label-danger"> NOTE : </span>&nbsp;Please check the students from the list for whom you want to generate lc.

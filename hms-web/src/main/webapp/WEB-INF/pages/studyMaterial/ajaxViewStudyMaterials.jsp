				...
				<div class="tabbable tabbable-custom tabbable-full-width">
					<ul class="nav nav-tabs">
						...
						<s:if test='%{user.isSchoolStudent!="Y"}'>
							 <li>
								<s:url id="urlAddStudyMaterial" action="ajaxDoAddStudyMaterial" namespace="/admin">
								</s:url>
								<sj:a id="addSub" href="%{urlAddStudyMaterial}" targets="classContentDiv" data-toggle="tab">Add Study Material</sj:a> 	
							 </li>
						 </s:if>
						 </s:if>
						 <li class="active">
							<s:url id="urlviewStudyMaterials" action="ajaxViewStudyClassMaterialList" namespace="/admin">
							</s:url>
							<sj:a id="viewSub" href="%{urlviewStudyMaterials}" targets="mainContentDiv" data-toggle="tab">View</sj:a> 	
						 </li>
					</ul>
...
function getDoGetStudyClasses(classId) {

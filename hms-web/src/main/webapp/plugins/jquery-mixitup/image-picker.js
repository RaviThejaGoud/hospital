...
(function() {
  ...
  ImagePickerOption = (function() {
    ...
    ImagePickerOption.prototype.mark_as_selected = function() {
      this.node.attr("id",this.node.find(".thumbnail").attr("id"));
    ...
    ImagePickerOption.prototype.create_node = function() {
      var image, thumbnail;
      this.node = jQuery("<li/>");
      image = jQuery("<img class='image_picker_image' style='height: 128px;width:290px;' />");
      image.attr("src", this.option.data("img-src"));
      thumbnail = jQuery("<div style='height:140px;' class='thumbnail col-md-2 col-sm-3 category_1' id="+this.option.val()+">");
      thumbnail.click({
        option: this
      }, function(event) {

var TableEditable = function () {
    ...
    return {
        ...
        init: function () {
            ...
            jQuery('#sample_editable_2_wrapper .dataTables_filter input').addClass("form-control input-medium"); // modify table search input
            ...
            jQuery('#sample_editable_3_wrapper .dataTables_filter input').addClass("form-control input-medium"); // modify table search input

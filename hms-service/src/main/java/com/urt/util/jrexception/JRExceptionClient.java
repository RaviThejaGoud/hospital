...
public class JRExceptionClient  {
	...
	public void sendException(final Throwable throwable){
		...
		/*		if(!ObjectFunctions.isNullOrEmpty(getUser())) {
					...
					//jrExceptionThread.setAcademicDetailsId((int)getcurrUserAcademicDetailsId());
					jrExceptionThread.setAcademicDetailsId((int)getCurrentAcademicId());

...
public final class ConvertUtil {
    ...
    public static Object getObjectFromSet(Set oSet) {
        Object option=null;
        for (Iterator it = oSet.iterator(); it.hasNext();) {
            option = (Object) it.next();
            break;
        }
        return option;
    }
    /**
     * Method to convert a List to a Set
     * @param list a given List
     * @return Set a collection of objects created from list
     */
     ...
     * @return List a collection of objects created from set
     */
...
*/
    ...
    /**
     * Convenience method to clone and return the given object.
     *
     * @param o the object to tranfer properties from
     * @return converted object
     */
    public static Object cloneObject(Object o) throws Exception {
        ...
        Object target = Class.forName(o.getClass().getName()).newInstance();
        BeanUtils.copyProperties(target, o);
        return target;
    }

...
import com.urt.persistence.model.exam.ViewExamSchedulePK;

/*
 * @create new table customer.
 */
@Entity
@Table(name = "challanaFeePaidDetails")
public class ChallanaFeePaidDetails  extends PersistentObject {
	
    private static final long serialVersionUID = 3832626162173359411L;
    
    
    protected long custId;
    protected Long challanaPaymentId;
     ...
     */
	public Long getChallanaPaymentId() {
		return challanaPaymentId;
	}
	public void setChallanaPaymentId(Long studentPaymentId) {
		this.challanaPaymentId = challanaPaymentId;
	}
	...
	public ChallanaFeePaidDetails() {
		this.createdDate = new Date();
    	this.lastAccessDate = new Date();
    	this.lastUpdatedDate = new Date();
    }
	public ChallanaFeePaidDetails(long id) {
        setId(id);
    }

	@Override
	public int compareTo(Object object) {
		ChallanaFeePaidDetails myClass = (ChallanaFeePaidDetails) object;

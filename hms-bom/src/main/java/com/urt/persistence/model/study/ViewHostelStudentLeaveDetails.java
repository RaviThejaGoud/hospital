...
@Entity
@Table(name = "vw_hostelStudentLeaveDetails")
public class ViewHostelStudentLeaveDetails  implements Serializable,Cloneable,Comparable {

	private static final Log log = LogFactory.getLog(ViewHostelStudentLeaveDetails.class);
    /**
   ...
   public String getImageName() {
    ...
    public ViewHostelStudentLeaveDetails(long accountId, long custId,
	...
	public int compareTo(Object object) {
    	ViewHostelStudentLeaveDetails myClass = (ViewHostelStudentLeaveDetails) object;
...
public ViewHostelStudentLeaveDetails()
{
    super();
}

...
@Table(name = "vw_staffAttendance")
public class VWStaffAttendance implements java.io.Serializable {
	...
	/** default constructor */
	public VWStaffAttendance() {
	}

	/** minimal constructor */
	public VWStaffAttendance(Long accountId, Long custId, Long staffId, String username, Long attendanceId,
	...
	/** full constructor */
	public VWStaffAttendance(Long accountId, Long custId, Long staffId,
			Long academicYearId, 
			String username, 
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		VWStaffAttendance other = (VWStaffAttendance) obj;
  ...
  @Column(name = "noOfPresentDays", nullable = true, length = 1,columnDefinition = "varchar(5)")
	...
	/**
     * @param noOfPresentDays the noOfPresentDays to set
     */

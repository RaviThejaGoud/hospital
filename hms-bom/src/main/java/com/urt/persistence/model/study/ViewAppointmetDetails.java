 ...
 * All Rights Reserved 
 *
  * File: ViewAppointmetDetails.java
 ********************************************************************
 *
...
@Entity
@Table(name = "vw_parentAppointmentDetails")
public class ViewAppointmetDetails  implements Comparable,Serializable,Cloneable {
     ...
     */
     ...
     private String staffClassAndSection;
     private String studClassAndSection;
	...
	public String getStaffClassAndSection() {
		return staffClassAndSection;
	}
	public void setStaffClassAndSection(String staffClassAndSection) {
		this.staffClassAndSection = staffClassAndSection;
	}
	public String getStudClassAndSection() {
		return studClassAndSection;
	}
	public void setStudClassAndSection(String studClassAndSection) {
		this.studClassAndSection = studClassAndSection;
	}
	@Override
	public int compareTo(Object o) {
	 ...
	 @Transient
		...
		@Transient
	    public String getScheduleDateFormatStr()
	    {
	        return DateFormatter.formatDate(DateFormatter.ddMMMyyyy_PATTERN1, getScheduleDate()); 
	    }

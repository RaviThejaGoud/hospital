...
@Entity
@Table(name = "substitutionTimeTable")
public class SubstitutionTimeTable  extends PersistentObject {
    ...
    public SubstitutionTimeTable(long id) {
        setId(id);
    }

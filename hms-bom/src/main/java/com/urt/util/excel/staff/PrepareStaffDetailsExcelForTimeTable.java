...
public class PrepareStaffDetailsExcelForTimeTable {
    ...
    /*private DataValidation createStudySubjectsDropDownList(int srow, int erow) {

    	DataValidation dataValidation = null;
    	try {

    	    CellRangeAddressList addressList = new CellRangeAddressList(srow, erow, subpos, subpos);
    	    //DVConstraint dvConstraint = DVConstraint.createFormulaListConstraint("StudySubjectsAndBranchesAndDaysListSheet!$B$5:$B$" + subend);
    	    DVConstraint dvConstraint = DVConstraint.createFormulaListConstraint("StudySubjectsAndBranchesAndDaysListSheet!$B$5:$B$12");
    	    dataValidation = new HSSFDataValidation(addressList, dvConstraint);
    	    dataValidation.setSuppressDropDownArrow(false);
    	    dataValidation.createPromptBox("Subject Name", "Select from dropdown!");
    	    dataValidation.setShowPromptBox(true);
    	    dataValidation.setErrorStyle(DataValidation.ErrorStyle.STOP);
    	    dataValidation.createErrorBox("Invalid SubjectName", "Please select the subject from the dropdown!");
    	} catch (Exception ex) {
    	    ex.printStackTrace();
    	}
    ...
    private DataValidation createStaffDropDownList(int srow, int erow) {
    	DataValidation dataValidation = null;
    	try {
    	    CellRangeAddressList addressList = new CellRangeAddressList(srow, erow, staffpos, staffpos);
    	    DVConstraint dvConstraint = DVConstraint.createFormulaListConstraint("StudySubjectsAndBranchesAndDaysListSheet!$B$63:$B$" + staffend);
    	    dataValidation = new HSSFDataValidation(addressList, dvConstraint);
    	    dataValidation.setSuppressDropDownArrow(false);
    	    dataValidation.createPromptBox("Staff Name", "Select from dropdown!");
    	    dataValidation.setShowPromptBox(true);
    	    dataValidation.setErrorStyle(DataValidation.ErrorStyle.STOP);
    	    dataValidation.createErrorBox("Invalid DayName", "Please select the day from the dropdown!");
    	} catch (Exception ex) {
    	    ex.printStackTrace();
    	}
    	return dataValidation;
	...
	return styles;
        ...
        /*private DataValidation createAllDaysDropDownList(int srow, int erow) {

        	DataValidation dataValidation = null;
        	try {

        	    //CellRangeAddressList addressList = new CellRangeAddressList(srow, erow, cpos, cpos);
        		CellRangeAddressList addressList = new CellRangeAddressList(srow, erow, 2, 2);
        	    DVConstraint dvConstraint = DVConstraint.createFormulaListConstraint("ClassStaff!$B$5:$B$" + dayend);
        	    dataValidation = new HSSFDataValidation(addressList, dvConstraint);
        	    dataValidation.setSuppressDropDownArrow(false);
        	    dataValidation.createPromptBox("Day", "Select from dropdown!");
        	    dataValidation.setShowPromptBox(true);
        	    dataValidation.setErrorStyle(DataValidation.ErrorStyle.STOP);
        	    dataValidation.createErrorBox("Invalid Class", "Please select the day from the dropdown!");
        	} catch (Exception ex) {
        	    ex.printStackTrace();
        	}
        	return dataValidation;

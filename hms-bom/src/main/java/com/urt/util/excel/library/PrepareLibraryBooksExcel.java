...
public class PrepareLibraryBooksExcel {
    ...
    private static final String[] titles = {"Book Title Id", "Subjects","Classes","Section", "Book Name","Book Code","Book KeyWord", "Author Name", "Publisher Name", "No Of Copies","Cost Of Book", 
    	"Max Allowed to Issue","Max allowed days that student can hold","Subject Name","Date","Year of Publication","Call No.", "Class No.","Edition","Pages","Bill No","Place","Remarks","Language","Acquisition Number"};
   ...
   */ 
    ...
    public static final String query = "select bt.id,ss.name, cl.className,bt.sections,bt.bookName,'',bt.bookKeyWord,"
    ...
    public void createLibraryBookSheet(String sheetName,  String sheetTitleDesc,String generateNum) {
    	...
    	try {
    	    ...
    	    if(!StringFunctions.isNullOrEmpty(generateNum) && generateNum.toString().equalsIgnoreCase("AG")){
